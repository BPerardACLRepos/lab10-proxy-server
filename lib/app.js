...
app.get('/location', async (req, res) => {
  try {
    ...
    const formattedLocation = getLocation(responseData);
...
app.get('/weather', async (req, res) => {
  try {
    ...
    const formattedForecasts = getForecast(responseForecasts);
...
app.get('/weather', async (req, res) => {
  try {
    ...
    const formattedReviews = getReviews(responseReviews);
